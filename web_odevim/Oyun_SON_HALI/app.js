...
function check() {
    ...
    if (numberOfFound == selectedWord.length) {
        resultElem.textContent = 'TEBRIKLER! KAZANDINIZ!';
    ...
    if (found === false) {
        numberOfTries++;
        currentStatus.src = 'img/status_' + numberOfTries + '.png';

        var resultText = numberOfTries + ' kere denediniz.'
        resultText += '<br />';
...
function initElement() {
   ...
   var words = ['KUROMI', 'MELODY', 'HELLOKITTY', 'CINNAMOROLL', 'POMPOMPURIN', 'KEROPPI', 'BADTZMARU'];
